...
logo = """
 ...
 🔯°────────(Rk Faisal)────────°🔯
\033[1;92mHACKING--IS`T--CRIME--IT`S--A--GAME--AGAINST--OF--THE--SYSTEM
\033[1;96m☛✪ Creator ✯ Faisu X3 Deep       ☚    
\033[1;98m☛✪ King is Back           ☚  
...
print  """
\033[1;97m------------------------------------------------
\033[1;96m~HACKING--IS`T--CRIME--IT`S--A--GAME--AGAINST--OF--THE--SYSTEM~
\033[1;97m------------------------------------------------

\033[1;92m ______   _______  _______  _______ 
...
\033[1;92m(______/ (_______/(_______/|/       
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Zidi_Deep
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;96mWrong Password"
            os.system('xdg-open https://www.facebook.com/jaiparakash.prajapti')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mZIDI-DEEP\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mZIDI DEEP\033[1;95m◈•══════•◈•"
		try:
	...
	print "   \033[1;92m____________________________________"

	jalan('          \033[1;91mDEEP start cloning Wait...')
	print  "  \033[1;92m____________________________________" 
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mZIDI-DEEP\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By FAISU-DEEP--•◈•---»" #Dev:zidi
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 ZidiDeep.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Zidi Deep Creations.\033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mSajidKhan"""
